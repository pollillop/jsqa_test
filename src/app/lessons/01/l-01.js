...
// Task 01.01 - 1 point
console.log('Question: Can JavaScript file contain non-executable code?');
console.log('Answer: Non-executable code can be considered as comment.');

// Task 01.02 - 2 points
console.log('\nQuestion: How we can tell the JS interpreter to use strict mode?');
console.log('Answer: \'use strict\'');

// Task 01.03 - 2 points
console.log('\nQ: What simple data types are used in JS?');
console.log('A: number, string, boolean, null, undefined');

// Task 01.04 - 2 points
console.log('\nQ: What complex data types are used in JS?');
console.log('A: object, array, function');
